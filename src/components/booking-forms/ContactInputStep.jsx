      ...
      <div className="mb-8">
        <div className="flex justify-center relative px-7 flex-col text-left gap-2">
          ...
          <input
            ...
            className="flex-1 bg-white/10 border border-white/30  rounded-2xl px-6 py-6 text-white placeholder-pink-200 focus:border-pink-400 focus:bg-white/15 outline-none transition-all duration-300 text-xl "
          />
        </div>
      </div>
      <div className="mb-8">
